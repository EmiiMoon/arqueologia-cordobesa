<!-- 
    insert_form.php
    Página que contiene el formulario para introducir los datos de un nuevo marcador.
-->
...
<body>
    ...
    <!-- Formulario para introducir los datos del sitio, que se envian mediante POST a la página "db_edit.php"
    que es la página que se encarga de insertar, actualizar y eliminar los marcadores de la base de datos -->
    <form method="post" action="db_edit.php?lat=37.89155&lng=-4.77275" class="formulario" >
        ...
        <div class="campo">
            <textarea class="campo__field--textarea" name="info" id="info">Información del sitio.</textarea>
        </div>

        <!-- Botones de aceptar y cancelar -->
        <div class="campo">
            
            <!-- El botón de aceptar envía la información del formulario. Mediante name="insert" se indica
            a la página "db_edit" que debe insertar un nuevo marcador en la base de datos. -->
    ...
    <script>
        ...
        function initMap() {
            ...
            map.addListener("click", (e) => {
                ...
                // Se modifica el atributo "action" del formulario, y añadimos los parámetros latitud y longitud 
                // para que se envíen mediante GET.
                $(".formulario").attr('action', 'db_edit.php?lat=' + $lat + '&lng=' + $lng);
